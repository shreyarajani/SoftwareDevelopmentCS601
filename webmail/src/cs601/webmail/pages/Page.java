...
public abstract class Page {
	static STGroup templates = new STGroupDir(WebmailServer.RESOURCES_CS601_WEBMAIL_TEMPLATES); // call unload() to wack the cache
	static {
...
//        if ( mustBeLoggedIn() && !isLoggedIn(request,response) ) {
